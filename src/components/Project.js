...
function Project() {
  return (
    <div id="Projects">
          ...
          <div class="card px-5 mb-5 bg-light">
            ...
            <div class="card-body">
              ...
              <p className="card-text">
                Developed a caption generator in which we can build one such
                annotation tool capable of generating relevant captions for the
                image .
              </p>
            </div>
          </div>
        ...
        <div class=" col-md-4 col-sm-12">
          <div class="card px-5 mb-5 bg-light">
            ...
            <div class="card-body">
              ...
              <br></br>
              <p className="card-text">
                I have build a model which predicts the leaf disease by using
                CNN architectures. I used VGG19 and LeNet CNN architectures.
              </p>
            </div>
          </div>
        </div>
        <div class=" col-md-4 col-sm-12">
          <div class="card px-5 mb-5 bg-light">
            ...
            <div class="card-body">
              ...
              <br></br>
              <p className="card-text">
                I have made a self balancing robot which is an automated vehicle
                that balances itself without support.
              </p>
            </div>
          </div>
        </div>
      ...
      <center>
        <a
          href="https://www.linkedin.com/in/harsha-vardhan-0a1873236/"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/_parth_ke_krishna_/"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://github.com/SRIRADHAKRISHNASAKHA"
          target="_blank"
          rel="noopener noreferrer"
        >
