            ...
            <div class="row ">
                ...
                <div class="col-">
                    <div style={{width:"70%"}} class="about-info mx-3 shadow ">
                        ...
                        <p class="px-5 pb-3">I am the self motivated person. I believe in my hardwork and my attempts irrespective of the result .
                        my strenghts are my confidence and my hardwork. My philosophy is living at the moment because the moment may or may not come again. </p>
                    </div>
                </div>
                </center>
                <br></br>
